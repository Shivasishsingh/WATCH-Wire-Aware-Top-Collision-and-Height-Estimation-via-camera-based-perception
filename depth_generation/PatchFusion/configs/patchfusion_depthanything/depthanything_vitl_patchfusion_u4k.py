...
model=dict(
    ...
    config=dict(
        ...
        max_depth=max_depth,
        load_branch=True,
        pretrain_model=['/Vaibhav/shivasish1/sam2/PatchFusion/pretrained_models/coarse_pretrain.pth', '/Vaibhav/shivasish1/sam2/PatchFusion/pretrained_models/fine_pretrain.pth'], # coarse, fine
