...
model.load_state_dict(torch.load(r'/Vaibhav/shivasish1/PDFNet/checkpoints/PDFNet/PDFNet_swinB2025-11-14_12_54_53/97_best_f1_0.811594_mae_0.008136_PDFNet_swinB.pth',map_location='cpu'),strict=False)
...
test_dir = {
    ...
    "Bhopal_1":r'/Vaibhav/shivasish1/PDFNet/Bhopal_1/images',
...
if save_dir is None:
    save_dir = f'/Vaibhav/shivasish1/PDFNet/resulta_bhopal_1/{file_name}'
if not TEST_MODE:
